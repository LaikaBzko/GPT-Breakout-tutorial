...
// Linebatch.cs
// originally written by David Amador and made available on 26th jan 2010 on ht tp://w ww.david-amador.com/2010/01/drawing-lines-in-xna/
...
namespace Tutorial_1.RC_Framework
{
    ...
    public class LineBatch
    {
        ...
        /// </summary>
        public static Texture2D _empty_texture;
        ...
        /// the rectange is widthInPixels pixels wide and widthInPixels pixels outside therectange
        /// it uses a loop to draw the rectangle its fairly slow if more than 1 pixel in width 
        /// becuase its slow consider drawLettebox instead
        /// </summary>
        /// <param name="batch"></param>
        /// <param name="r"></param>
        /// <param name="c"></param>        
        static public void drawLineRectangleOuter(SpriteBatch batch, Rectangle r, Color c, int widthInPixels)
        {
        ...
        // **************************************  draw a letterbox (like a frame or mask) ***********************************************

        static public void drawLetterbox(SpriteBatch sb, Rectangle outerRectangle, int widthOfMask, Color maskColor)
        {
            ...
            sb.Draw(_empty_texture, r, maskColor);
