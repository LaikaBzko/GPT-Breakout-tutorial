...
namespace Tutorial_1.RC_Framework
{
    ...
    public class ButtonAnn : RC_RenderableBounded
    {
        ...
        public override bool MouseOver(float mouse_x, float mouse_y)
        {
            ...
            if (Contains((int)mouse_x, (int)mouse_y))
            {
    ...
    class TextRenderableFade : TextRenderable
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            curColour = Color.Lerp(colour, finalColour, ticks / (float)fadeTicks);
            curPos = curPos + drift;
        }
    ...
    class CircleFade : RC_RenderableBounded //(and resize as well)
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            lerp = ticks / (float)fadeTicks;
            if (reverse) lerp = 1 - lerp;

            curColour = Color.Lerp(initColour, finalColour, lerp);
            curPos.X = MathHelper.Lerp(initPosition.X, finalPosition.X, lerp);
            curPos.Y = MathHelper.Lerp(initPosition.Y, finalPosition.Y, lerp);
            curRadius = MathHelper.Lerp(initRadius, finalRadius, lerp);
        }
    ...
    public class ScrollBackGround : RC_RenderableBounded
    {
        ...
        public override void Draw(SpriteBatch sb)
        {
            ...
            if (direction == 1) //Vertical scroll
            {
                ...
                float ratio = bounds.Height / (float)sourceRectangle.Height;
            ...
            if (direction == 2) //Horizontal scroll
            {
                ...
                float ratio = bounds.Width / (float)sourceRectangle.Width;
    ...
    public class GridBackGround : RC_RenderableBounded
    {
        ...
        public override void Draw(SpriteBatch sb)
        {
            ...
            Color c;
            float ll = v / ((float)ticksToLerp / 2);
