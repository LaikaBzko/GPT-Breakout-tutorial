...
namespace Tutorial_1.RC_Framework
{
    ...
    public class WayPoint
    {
        ...
        {
            pos = new Vector2(w.pos.X, w.pos.Y);
            speed = w.speed;
        }
    }
    ...
    public class WayPointList
    {
        ...
        /// previously this was called dir
        /// </summary>
        public int wlDirection { set; get; }
        ...
        public bool nextLeg()
        {
            ...
            currentLeg = currentLeg + wlDirection;
        ...
        /// previously there was only one zigzag param - so make  startZigZag the same as endZigZag for compatibilty
        /// </summary>
        /// <param name="startPos"></param>
        /// <param name="endPos"></param>
        /// <param name="startZigZag"></param>
        /// <param name="endZigZag"></param>
        /// <param name="steps"></param>
        /// <param name="speed"></param>
        public void makePathZigZag(Vector2 startPos, Vector2 endPos, Vector2 startZigZag, Vector2 endZigZag, int steps, float speed)
        {
            lst = new List<WayPoint>();
            float zig = 1;
            for (int i = 0; i < steps; i++)
            {
                ...
                z.Y = MathHelper.Lerp(startZigZag.Y, endZigZag.Y, lerp);
                z.Y = MathHelper.Lerp(startZigZag.Y, endZigZag.Y, lerp);
                v = v + zig * z;
                WayPoint w = new WayPoint(v, speed);
                add(w);
        ...
        /// <summary>
        /// Just a subdivided line - more for use with position factories and particle systems than sprites
        /// since a sprite with a constant speed and just two ends is easier
        /// </summary>
        /// <param name="startPos"></param>
        /// <param name="endPos"></param>
        /// <param name="steps"></param>
        /// <param name="speed"></param>
        public void makePathLineWithSteps(Vector2 startPos, Vector2 endPos, int steps, float speed)
        {
            lst = new List<WayPoint>();
            for (int i = 0; i < steps; i++)
            {
