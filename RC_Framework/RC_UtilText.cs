...
namespace Tutorial_1.RC_Framework
{
    ...
    public class UtilTexSI
    {
        ...
        /// <summary>
        /// initialise the textures need a graphics device
        /// </summary>
             ...
             Color botLeftC, Color botRightC)
        {
            ...
            for (int x = 0; x < width; x++)
                ...
                {
                    float lerpValX = x / (float)width;
                    float lerpValY = y / (float)height;
